    ...
    <div className='w-full bg-light-blue py-5 sm:py-0'>
      <div className='w-full flex justify-center items-center flex-col gap-3'>
        <div className='md:p-12'>
          <h3
            className={`${style.title_partner} text-center text-[30px] sm:text-[44px] lg:text-6xl font-extrabold lg:mt-8`}>
            My Certificate
          </h3>
          ...
          <div className='flex gap-2 justify-center my-5'>
            ...
            <span
              className={
                'w-3 h-3 sm:w-4 sm:h-4 inline-block rounded-full' +
                (index === 4 ? ' bg-slate-600' : ' bg-slate-400')
              }></span>
            <span
              className={
                'w-3 h-3 sm:w-4 sm:h-4 inline-block rounded-full' +
                (index === 5 ? ' bg-slate-600' : ' bg-slate-400')
              }></span>
            <span
              className={
                'w-3 h-3 sm:w-4 sm:h-4 inline-block rounded-full' +
                (index === 6 ? ' bg-slate-600' : ' bg-slate-400')
              }></span>
          </div>
        </div>
      </div>
